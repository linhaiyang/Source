...
- (void)showFastView:(NSInteger)draggedTime totalTime:(NSInteger)totalTime isForward:(BOOL)forawrd {
    ...
    if (forawrd) {
        self.fastImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"ZFPlayer_fast_forward"]];
    } else {
        self.fastImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"ZFPlayer_fast_forward"]];
    }
...
- (UIButton *)repeatBtn {
    if (!_repeatBtn) {
        ...
        [_repeatBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"ZFPlayer_repeat_video"]] forState:UIControlStateNormal];
    }
    return _repeatBtn;
}
...
- (UIButton *)closeWatchrRecordBtn {
    if (!_closeWatchrRecordBtn) {
        ...
        [_closeWatchrRecordBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_关闭"]] forState:UIControlStateNormal];
    }
