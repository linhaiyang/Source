...
- (UIButton *)backBtn {
    if (!_backBtn) {
        ...
        [_backBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_左箭头白"]] forState:UIControlStateNormal];
    }
    return _backBtn;
}
...
- (UIButton *)playOrPauseBigBtn {
    if (!_playOrPauseBigBtn) {
        ...
        [_playOrPauseBigBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_play"]] forState:UIControlStateNormal];
        [_playOrPauseBigBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_stop"]] forState:UIControlStateSelected];
    }
...
- (UIButton *)playOrPauseSmallBtn {
    if (!_playOrPauseSmallBtn) {
        ...
        [_playOrPauseSmallBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_播放"]] forState:UIControlStateNormal];
        [_playOrPauseSmallBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_暂停"]] forState:UIControlStateSelected];
    }
...
- (UIButton *)sendBarrageBtn {
    if (!_sendBarrageBtn) {
        ...
        [_sendBarrageBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_发表弹幕"]] forState:UIControlStateNormal];
    }
...
- (UIButton *)openOrCloseBarrageBtn {
    if (!_openOrCloseBarrageBtn) {
        ...
        [_openOrCloseBarrageBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_弹幕"]] forState:UIControlStateNormal];
        [_openOrCloseBarrageBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_关闭弹幕"]] forState:UIControlStateSelected];
    }
...
- (UISlider *)videoSlider {
    if (!_videoSlider) {
        ...
        [_videoSlider setThumbImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"椭圆-1"]] forState:UIControlStateNormal];
...
- (UIButton *)exitFullScreenBtn {
    if (!_exitFullScreenBtn) {
        ...
        [_exitFullScreenBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_缩屏"]] forState:UIControlStateNormal];
        [_exitFullScreenBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_退出全屏"]] forState:UIControlStateHighlighted];
    }
