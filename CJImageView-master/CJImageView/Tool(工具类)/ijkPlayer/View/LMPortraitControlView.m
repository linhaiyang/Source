...
- (UIButton *)backBtn {
    if (!_backBtn) {
        ...
        [_backBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_播放页_返回"]] forState:UIControlStateNormal];
    }
    return _backBtn;
}
...
- (UIButton *)shareBtn {
    if (!_shareBtn) {
        ...
        [_shareBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_播放页_分享"]] forState:UIControlStateNormal];
    }
    return _shareBtn;
}
...
- (UIButton *)playOrPauseBtn {
    if (!_playOrPauseBtn) {
        ...
        [_playOrPauseBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_播放"]] forState:UIControlStateNormal];
        [_playOrPauseBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_暂停"]] forState:UIControlStateSelected];
    }
...
- (UIButton *)fullScreenBtn {
    if (!_fullScreenBtn) {
        ...
        [_fullScreenBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"IJK.bundle/%@", @"btn_全屏"]] forState:UIControlStateNormal];
    }
