...
-(id)init
{
    if (self = [super init]) {
        //测试环境
        self.develpoerDictionary=@{ACCOUNT_SERVERCENTER_Key:@"https://storetest.quyibao.com/",PICTURE_SERVERCENTER_key:@"http://198:85/image-service/",BUSINESSLOGIC_SERVERCENTER_key:@"业务逻辑前缀",UPDATEVERSION_SERVERCENTER_key:@"版本升级前缀"};
        //产品环境
        self.productDictionary=@{ACCOUNT_SERVERCENTER_Key:@"https://storetest.quyibao.com/",PICTURE_SERVERCENTER_key:@"http://baidues.com/",BUSINESSLOGIC_SERVERCENTER_key:@"业务逻辑前缀",UPDATEVERSION_SERVERCENTER_key:@"版本升级前缀"};
